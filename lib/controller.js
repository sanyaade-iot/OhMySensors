...
class Controller {
  ...
  async _updateLastSeen(nodeId, childSensorId, sensorId = null) {
    ...
    var update = async (id) => {
      ...
      this._eventManager.emit('sensorSeen', {
        nodeId: nodeId,
    ...
    if (parsedMessage.messageType === 'internal') {
      switch(parsedMessage.subType) {
        case 'I_BATTERY_LEVEL':
          ...
          this._eventManager.emit('batteryLevelUpdated', {
        ...
        case 'I_ID_REQUEST':
          ...
          toSend = parsedMessage;
          this._eventManager.emit('nodeRegistered', {
            nodeId: nodeId
          });
          break;
        ...
        case 'I_LOG_MESSAGE':
          ...
          // TODO : store log?
          this._eventManager.emit('logReceived', {
            nodeId: parsedMessage.nodeId,
        ...
        case 'I_SKETCH_NAME':
          ...
          this._eventManager.emit('sketchNameUpdated', {
            nodeId: parsedMessage.nodeId,
        ...
        case 'I_SKETCH_VERSION':
          ...
          this._eventManager.emit('sketchVersionUpdated', {
            nodeId: parsedMessage.nodeId,
      ...
      if (!sensorExist) {
        ...
        this._eventManager.emit('sensorRegistered', {
          nodeId: parsedMessage.nodeId,
          childId: parsedMessage.childSensorId,
          sensorId: sensorId,
          type: parsedMessage.subType,
          description: parsedMessage.payload,
          variables: SerialProtocol.getAllVariableDetailsForSensor(parsedMessage.subType),
      ...
      this._eventManager.emit('dataReceived', {
        nodeId: parsedMessage.nodeId,
        childId: parsedMessage.childSensorId,
        sensorId: sensorId,
        type: parsedMessage.subType,
