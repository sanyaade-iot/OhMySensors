...
var setReqSensorTypesAllowedByVariableType = {
...
var setReqVariableContent = {
  ...
  'V_SCENE_ON': 'unknown',
  'V_SCENE_OFF': 'unknown',
  'V_HVAC_FLOW_STATE': 'string',
  'V_HVAC_SPEED': 'string',
  'V_LIGHT_LEVEL': 'percentage',
  'V_VAR1': '*',
  'V_VAR2': '*',
  'V_VAR3': '*',
  'V_VAR4': '*',
  ...
  'V_STOP': 'blank',
  'V_IR_SEND': 'undefined',
  'V_IR_RECEIVE': 'undefined',
  'V_FLOW': 'numeric',
  'V_VOLUME': 'numeric',
  'V_LOCK_STATUS': 'binary',
  'V_LEVEL': 'numeric',
  'V_VOLTAGE': 'numeric',
  'V_CURRENT': 'numeric',
  'V_RGB': 'color',
  'V_RGBW': 'color',
  'V_ID': 'id',
  'V_UNIT_PREFIX': 'undefined',
  'V_HVAC_SETPOINT_COOL': 'percentage',
  'V_HVAC_SETPOINT_HEAT': 'percentage',
  'V_HVAC_FLOW_MODE': 'string'
};
...
module.exports = {
  ...
  setReq: setReq,
  setReqSensorTypesAllowedByVariableType: setReqSensorTypesAllowedByVariableType,
  setReqVariableContent: setReqVariableContent,
  internal: internal
};