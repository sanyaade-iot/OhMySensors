...
var getAllVariableDetailsForSensor = function(sensorType) {
  var allowed = variableTypesCanReqSet(sensorType);
  var object = {};

  allowed.forEach(function(variable) {
    // Strip custom variables (TODO: handle this?)
    if (variable === 'V_VAR1' || variable === 'V_VAR2' || variable === 'V_VAR3' || variable === 'V_VAR4' || variable === 'V_VAR5') {
      return;
    }
    object[variable] = variableDetails.valueTypeByVariableType[variable];
  });
...
module.exports = {
  ...
  getAllVariableDetailsForSensor: getAllVariableDetailsForSensor,
